...
\textbf{Figure 7 (learning curve).} DS2 VEB F1 (mean with min-max band),
sensitivity, and PPV versus DS1 training beats for the single-stage
model (T = 64, 2 seeds per point). \emph{Message: sensitivity is flat
and the F1 mean saturates by about a quarter of DS1; additional data
mainly narrows seed variance rather than raising accuracy.}
...
\bottomrule\noalign{}
\endlastfoot
Gated cascade (reference) & 0.923 & 0.616 & 0.739 & \textasciitilde23.4k
SynOps & (reference) \\
TCN & 0.939 & 0.729 & 0.821 & \textasciitilde1.02M MACs & -0.088
{[}-0.251, +0.082{]} \\
ResNet-lite & 0.910 & 0.761 & 0.829 & \textasciitilde539k MACs & -0.089
{[}-0.188, +0.009{]} \\
Gradient-boosted trees & 0.974 & 0.678 & 0.800 & \textasciitilde200
trees (depth 4) & -0.060 {[}-0.146, +0.019{]} \\
